...
if 'allauth' in settings.INSTALLED_APPS:
    from .forms import AllAuthPasswordResetForm, AllAuthPasswordResetConfirmForm
...
class PasswordResetConfirmSerializer(serializers.Serializer):
    ...
    """
        Serializer for requesting a password reset attempt.
    """
    email = serializers.EmailField()
    ...
    @property
    def password_reset_confirm_form_class(self):
        if 'allauth' in settings.INSTALLED_APPS:
            return AllAuthPasswordResetConfirmForm
        else:
            return PasswordResetForm
