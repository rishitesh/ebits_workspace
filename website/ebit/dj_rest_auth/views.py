...
class LoginView(GenericAPIView):
    ...
    def get_response(self, email):
        ...
        login_response = serializer.data
        login_response["user"] = self.user.username
        login_response["email"] = email
        response = Response(login_response, status=status.HTTP_200_OK)
        if api_settings.USE_JWT:
    ...
    def post(self, request, *args, **kwargs):
        ...
        self.login()
        return self.get_response(self.serializer.data.get("email"))
